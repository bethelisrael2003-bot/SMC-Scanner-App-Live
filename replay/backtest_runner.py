...
def my_custom_strategy(pair_data):
    ...
    Inputs:
      pair_data dictionary with:
        - "pair": "EUR/USD", etc.
        - "m15": list of M15 candles [{t, o, h, l, c, ao, ah, al, ac}]
        - "h1": list of H1 candles
        - "h4": list of H4 candles
        - "d1": list of D1 candles
        - "h1_atr": precomputed H1 ATR(14)
        
    Outputs:
      Return a list of signal dictionaries:
      [
        {
          "idx": int (M15 bar index of entry),
          "direction": "BUY" or "SELL",
          "sl": float (stop loss price),
          "targets": [(0.5, tp1_price), (0.5, tp2_price)] or [(1.0, tp_price)],
          "be_r": float (default 1.0),
          "stale_h": int (default 12)
        },
        ...
      ]
    """
    # Replace this with your custom algorithmic strategy!
    # By default, this returns empty. See the benchmark strategy below for an example.
    signals = []
    return signals
